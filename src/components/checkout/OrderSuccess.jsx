...
/**
 * Pantalla de confirmación tras crear el pedido. Muestra el código de acceso y
 * lleva a "Mis pedidos" para el seguimiento en vivo.
 */
      ...
      {order && (
        ...
        >
          ...
          >
            ...
            <h2 className="text-xl font-black text-light">¡Pedido confirmado!</h2>
            <p className="text-sm text-white/50 mt-1">
              Tu pedido entró a la cola. Te avisaremos cuando esté listo.
            </p>
            ...
            <div className="mt-5 rounded-xl bg-white/[0.04] border border-white/[0.08] p-4 space-y-3">
              ...
              <div className="pt-2 border-t border-white/10">
                <p className="text-[11px] uppercase tracking-wider text-white/40">
                  Código para consultar tu pedido
                </p>
