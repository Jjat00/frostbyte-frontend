        ...
        <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
          {sections.map((section, index) => (
            <motion.button
              ...
              className="group flex flex-col items-center gap-2 p-4 bg-dark-secondary/50 border border-gray/20 rounded-2xl hover:border-primary/50 hover:bg-dark-secondary transition-all duration-300"
            >
              <div
              ...
              <span className="text-light font-semibold text-sm group-hover:text-primary transition-colors duration-300">
                {section.name}
              </span>
              <span className="text-gray text-xs hidden md:block">
                {section.description}
              </span>
            </motion.button>
          ))}
