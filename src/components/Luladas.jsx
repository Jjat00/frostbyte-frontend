...
const Luladas = ({ showExtras = true }) => {
  ...
  useGSAP(() => {
    ...
    const title = section.querySelector(".lulada-title");
    const subtitle = section.querySelector(".lulada-subtitle");
    const cards = section.querySelectorAll(".lulada-card");
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-25">
        <div className="absolute top-20 left-10 w-96 h-96 bg-rose-500 rounded-full filter blur-[120px]" />
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-pink-500 rounded-full filter blur-[120px]" />
