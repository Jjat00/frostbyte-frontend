    ...
    >
      <div className="relative flex flex-col items-center">
        ...
        <div className="relative mb-3">
          ...
          <div className={`absolute inset-0 rounded-full border-2 md:border-4 lg:border-[6px] xl:border-[8px] ${styles.ringColor || 'border-red-400'} shadow-2xl`}></div>
          {/* Anillo interior */}
          <div className={`absolute inset-1 md:inset-2 lg:inset-4 xl:inset-5 rounded-full border md:border-2 lg:border-[4px] xl:border-[5px] ${styles.ringColor || 'border-red-400'} opacity-60`}></div>
          ...
          {styles.splash && (
            ...
            >
              <div className={`w-full h-full rounded-full ${styles.splashBg || 'bg-red-400'} opacity-80 blur-sm`}></div>
            </motion.div>
          )}
        </div>
        ...
        <div className="text-center space-y-2 md:space-y-3 lg:space-y-4 xl:space-y-5">
          {/* Nombre del producto */}
          <div className={`inline-block px-4 py-2 md:px-7 md:py-3 lg:px-10 lg:py-4 xl:px-12 xl:py-5 ${styles.labelBg || 'bg-gradient-to-r from-red-500 to-red-700'} rounded-lg shadow-lg`}>
          ...
          <div className="px-2 md:px-4">
            <p className="text-white font-semibold text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl mb-0.5">
              {product.description?.split(' ').slice(0, 3).join(' ') || 'Delicioso vino'}
            </p>
          ...
          {/* Precio */}
          <div className={`inline-block px-6 py-2.5 md:px-10 md:py-4 lg:px-14 lg:py-6 xl:px-16 xl:py-7 ${styles.priceButtonBg || 'bg-gradient-to-r from-red-500 to-red-700'} rounded-full shadow-xl transform transition-all duration-300 group-hover:scale-110`}>
...
const vinosStyles = {
  ...
  "casillero-del-diablo": {
    ...
    labelBg: "bg-gradient-to-r from-red-600 to-red-900",
    priceButtonBg: "bg-gradient-to-r from-red-600 to-red-900",
    splashBg: "bg-red-500",
    splash: true,
  },
};
...
const Vinos = () => {
  ...
  return (
    <section
      id="vinos"
      className="py-20 relative overflow-hidden bg-gradient-to-br from-red-600 via-red-800 to-red-950"
    >
      ...
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-20 left-10 w-96 h-96 bg-red-500 rounded-full filter blur-[120px]"></div>
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-red-700 rounded-full filter blur-[120px]"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-red-600 rounded-full filter blur-[120px]"></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 max-w-4xl mx-auto">
          {isLoading
