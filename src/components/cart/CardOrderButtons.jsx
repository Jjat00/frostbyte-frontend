...
/**
 * Botones de "pedir" para las tarjetas de producto (MenuSections).
 *
 * - Si los pedidos en línea están desactivados o el producto es "próximamente",
 *   no renderiza nada (la tarjeta queda como antes).
