      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            ...
            <div className="liquid-glass relative backdrop-blur-xl bg-white/[0.04] border border-cyan-500/15 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] rounded-3xl px-10 sm:px-16 py-8 sm:py-10 flex flex-col items-center text-center transition-all duration-300 group-hover:border-cyan-500/40">
