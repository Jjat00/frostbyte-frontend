...
const ProductCard = ({ product, index, styles }) => {
  ...
  return (
    ...
    >
      <div
        className={`liquid-glass-interactive backdrop-blur-xl bg-white/[0.04] border border-white/[0.1] rounded-2xl overflow-hidden h-full flex flex-col transition-all duration-300 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] hover:border-secondary/40 hover:bg-white/[0.07] hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_8px_32px_rgba(0,224,255,0.1)] ${
