    ...
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <Link
          ...
          className="flex items-center gap-2 px-3 md:px-4 py-2 border border-primary/35 bg-primary/[0.1] text-light rounded-lg hover:shadow-lg hover:shadow-primary/30 transition-all text-sm"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
        <Link
          ...
          className="group p-4 md:p-6 fb-card hover:border-primary/50 transition-all active:scale-[0.98]"
        >
        ...
        <Link
          to="/inventario/ordenes"
          className="group p-4 md:p-6 fb-card hover:border-secondary/50 transition-all active:scale-[0.98]"
        >
        ...
        <Link
          to="/inventario/stock-bajo"
          className="group p-4 md:p-6 fb-card hover:border-yellow-500/50 transition-all active:scale-[0.98] sm:col-span-2 lg:col-span-1"
        >
