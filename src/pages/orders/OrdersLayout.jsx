...
const OrdersLayout = () => {
  ...
  return (
    <div className="fb-screen fb-screen--plain flex min-h-screen flex-col md:flex-row">
              ...
              <div className="p-4 border-b border-white/[0.07]">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray">{user?.role_display || 'Mesero'}</p>
                  </div>
                </div>
              </div>
        ...
        <div className="p-3 border-t border-white/[0.1]">
          <div className="flex items-center gap-3 px-3 py-2 mb-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray">{user?.role_display || 'Mesero'}</p>
            </div>
          </div>
          <button
            onClick={handleLogout}
      ...
      {/* Main content */}
      <div className="flex-1 flex flex-col h-screen md:ml-64 min-w-0 overflow-x-hidden">
        {/* Page content */}
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white/[0.03] border-t border-white/[0.1] z-30 safe-area-pb overflow-x-auto no-scrollbar">
