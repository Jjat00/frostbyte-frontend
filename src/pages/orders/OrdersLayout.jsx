          ...
          <>
            ...
            >
              ...
              <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
                ...
                <div className="pt-4 border-t border-gray/20 mt-4">
                  <a
                    href="/"
                    className="flex items-center gap-3 px-4 py-3.5 rounded-xl text-gray hover:text-light hover:bg-gray/10 transition-all"
                  >
                    <Home className="w-5 h-5" />
                    <span className="font-medium">Ir al Menú</span>
                  </a>
                </div>
              </nav>
