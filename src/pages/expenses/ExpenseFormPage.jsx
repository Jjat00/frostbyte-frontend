  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <motion.form
        ...
        className="bg-dark-secondary rounded-xl p-6 border border-gray/10 space-y-6"
      >
        {/* Category selection */}
        <div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-dark border border-gray/20 rounded-lg text-light placeholder:text-gray focus:outline-none focus:border-primary/50"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-4 py-3 bg-dark border border-gray/20 rounded-lg text-light placeholder:text-gray focus:outline-none focus:border-primary/50 resize-none"
          />
        </div>
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            onChange={handleChange}
            className="w-5 h-5 rounded border-gray/20 bg-dark text-primary focus:ring-primary/50"
          />
        ...
        <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray/10">
          <button
            type="button"
            onClick={() => navigate(-1)}
            className="px-4 py-2.5 text-gray hover:text-light transition-colors"
          >
            Cancelar
          </button>
          <button
            ...
            className="flex items-center gap-2 px-6 py-2.5 bg-primary text-dark rounded-lg font-medium hover:bg-primary/90 transition-colors disabled:opacity-50"
          >
