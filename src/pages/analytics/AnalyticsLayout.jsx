  ...
  return (
    <div className="fb-screen fb-screen--plain flex min-h-screen flex-col md:flex-row">
                  ...
                  return (
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        `${baseClasses} ${
                          isActive
                            ? "border border-primary/30 bg-primary/[0.08] text-light"
                            : ""
                        }`
                      }
                    >
      ...
      <motion.aside
        ...
        className="fixed left-0 top-0 z-20 flex h-screen flex-col overflow-hidden border-r border-white/[0.07] bg-dark"
      >
        {/* Logo */}
        ...
        <div className={`border-t border-white/[0.1] ${collapsed ? "p-2" : "p-3"}`}>
          {collapsed ? (
            <div className="flex flex-col items-center gap-2">
              <div
                className="flex h-9 w-9 items-center justify-center rounded-full border border-white/[0.12] bg-white/[0.04] text-[0.78rem] font-medium text-light text-sm cursor-default"
            ...
            <>
              <div className="flex items-center gap-3 px-3 py-2 mb-2">
                <div className="w-10 h-10 rounded-full border border-white/[0.12] bg-white/[0.04] flex items-center justify-center text-dark font-bold flex-shrink-0">
                  {user?.first_name?.charAt(0) || user?.username?.charAt(0) || "U"}
                </div>
