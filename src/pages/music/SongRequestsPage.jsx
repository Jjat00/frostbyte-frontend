      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-2">
            <div className={`w-10 h-10 rounded-lg ${status.badgeClass} flex items-center justify-center`}>
              <Music className="w-5 h-5" />
            </div>
            <div>
              <h3 className="text-lg font-bold text-light">{request.song_name}</h3>
              <p className="text-gray text-sm">{request.artist_name}</p>
            </div>
          </div>
          
          {request.notes && (
            <p className="text-gray text-sm mt-2 ml-13 italic">"{request.notes}"</p>
          )}
        </div>
        
        <div className={`px-3 py-1 rounded-full text-xs font-medium ${status.badgeClass} flex items-center gap-1.5`}>
        ...
        {request.status === 'pending' && (
          <>
            ...
            <button
              ...
              className="px-4 py-2 bg-red-500/20 text-red-400 border border-red-500/30 rounded-lg hover:bg-red-500/30 transition-colors flex items-center justify-center gap-2 text-sm font-medium"
            >
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-gray">Gestiona las solicitudes de canciones de los clientes</p>
          </div>
          <button
            onClick={() => refetch()}
