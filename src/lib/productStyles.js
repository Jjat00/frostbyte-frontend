...
const productStyles = {
  ...
  'cafe': {
    icon: Coffee,
    gradient: 'from-amber-700 to-orange-900',
    image: 'https://i.pinimg.com/736x/31/66/96/316696f0392db53f35113671157c49c0.jpg',
  },
  'oreo': {
    icon: Cookie,
...
export function getProductStyles(product, categorySlug) {
  ...
  return {
    ...
    gradient: specificStyles.gradient || categoryStyles.gradient || 'from-gray-400 to-gray-600',
    visualGradient: specificStyles.visualGradient || categoryStyles.visualGradient,
    secondaryGradient: specificStyles.secondaryGradient || categoryStyles.secondaryGradient,
